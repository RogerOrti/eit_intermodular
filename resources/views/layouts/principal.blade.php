...
<head>
    ...
    @vite(['resources/css/style.css', 'resources/js/app.js', 'resources/js/botonFiltro.js'])
</head>
<body>
<header class="header-general">
    ...
    <nav class="menu-principal">
        <ul>
            ...
            <li><a href="{{ route('login') }}"><img class="img-icono" src="{{ asset('media/iconoUsuario.png')}}" alt="Icono usuario">Iniciar sessió</a></li>
        </ul>
    </nav>
</header>
@yield('home')
